...
class WordGenerator {
  ...
  static let possibleWords = ["ABCDE","APPLE", "TOADS", "CRANE", "QUERY", "GLARE", "HOUSE", "FROST", "BLINK", "JUICE", "MAGIC", "OCEAN", "PLUTO", "SNAKE", "TIGER", "VIBES", "WRIST", "YACHT", "ZEBRA", "BRICK", "FLAME"]
