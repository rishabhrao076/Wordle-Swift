    ...
    // START YOUR CODE HERE
      switch style {
          case .initial:
              ...
              layer.borderColor = UIColor.gray.cgColor
          case .incorrect:
              layer.backgroundColor = UIColor.init(red: 0.23, green: 0.23, blue: 0.23, alpha: 1.0).cgColor
              layer.borderColor = UIColor.init(red: 0.23, green: 0.23, blue: 0.23, alpha: 1.0).cgColor
          case .correctLetterOnly:
